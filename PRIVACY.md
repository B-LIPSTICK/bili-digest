...
| 字幕文本 / 你选中的文本 / 笔记草稿 / 自动记笔记时的当前句上下文 | 你在设置中选择的 AI 服务商（`api.deepseek.com` / `api.openai.com` / `api.moonshot.cn` / `open.bigmodel.cn` / `dashscope.aliyuncs.com`，或自定义端点） | 翻译、概览、逐句解释、笔记润色、自动记笔记 |

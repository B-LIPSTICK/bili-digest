...
- 保存带时间戳的笔记，可一键让 AI 润色错别字和语病
- 一键导出 Markdown：概览 + 双语字幕 + 笔记，可读回 Obsidian / Typora 等本地工具
...
3. 「字幕」页：点时间戳跳转，切换原文 / 译文 / 双语，悬停某句点「解释」；右上角「↓」导出 Markdown；
4. 「概览」页：生成内容概要、章节、要点和金句，金句可复制或直接存为笔记；
5. 「笔记」页：写下想法，点「AI 润色」改错别字和语病，再保存；保存后自动带上当前播放位置。
